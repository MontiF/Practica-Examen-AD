...
public class Main {
	private static Scanner sc = new Scanner(System.in); //scanner global para no tener que iniciarlo todo el rato
	...
	public static void main(String[] args) {
		...
		Empleado empleadoIniciado = iniciarSesion(); // inicializamos empleado dependiendo de lo que nos devuelva la funcion
	...
	private static Empleado iniciarSesion() {
		...
		for (Empleado e : listaEmpleados) { //recorremos el array de empleados y vamos comprobando las credenciales
